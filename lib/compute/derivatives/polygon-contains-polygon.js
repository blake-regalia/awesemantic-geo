...
let p_output = path.join(__dirname, `/../../data/selects/${s_type_a}-contains-${s_type_b}.csv`);
...
`, 'a', (s_select) => {
	return `
		select
			...
			b.osm_id b_osm_id,
			b.dbr_id b_dbr_id,
			st_containsproperly(a.polygons, b.polygons) as properly_contained
		from ${s_select},
			osm_polygons b
		where st_contains(a.polygons, b.polygons)
